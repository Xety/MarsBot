 ...
 * an empty instance of \Mars\Network\Http\CookieCollection will be created.
 *
 ...
 * MarsFramework comes with a few built-in strategies:
 *
 * - Basic
 * - Digest
 * - Oauth
 ...
 * MarsFramework comes with built-in support for basic authentication.
 *
 */
class Client {
 ...
 */
	protected $_defaultConfig = [
		'adapter' => 'Mars\Network\Http\Adapter\Stream',
		'host' => null,
		'port' => null,
		'scheme' => 'http',
		'timeout' => 30,
 ...
 * request host name.
 *
 * @var \Mars\Network\Http\CookieCollection
 */
	protected $_cookies;

/**
 * Adapter for sending requests. Defaults to
 * \Mars\Network\Http\Adapter\Stream
 *
 * @var \Mars\Network\Http\Adapter\Stream
 */
	protected $_adapter;
 ...
 *
 * @return \Mars\Network\Http\CookieCollection
 */
 ...
 *
 * @param \Mars\Network\Http\Request $request The request to send.
 ...
 * @param array $options The options to use. Contains auth, proxy etc.
 *
 * @return \Mars\Network\Http\Request
 */
