<?php
namespace Mars\Network\Http\Adapter;

use Mars\Configure\Configure\Exception\Exception;
use Mars\Network\Http\FormData;
use Mars\Network\Http\Request;
use Mars\Network\Http\Response;

/**
 * Implements sending \Mars\Network\Http\Request
...
class Stream
{
     ...
     *
     * @param \Mars\Network\Http\Request $request The request object to send.
     ...
     *
     * @param \Mars\Network\Http\Request $request The request to build context from.
     ...
     *
     * @param \Mars\Network\Http\Request $request The request being sent.
     ...
     * Array data will be processed with \Mars\Network\Http\FormData
     *
     * @param \Mars\Network\Http\Request $request The request being sent.
     * @param array $options Array of options to use.
     *
    ...
    protected function _buildSslContext(Request $request, $options)
    {
        ...
        if (empty($options['ssl_cafile'])) {
            $options['ssl_cafile'] = ROOT . DS . 'config' . DS . 'cacert.pem';
        }
     ...
     * @return array Array of populated Response objects
     *
     * @throws \Mars\Configure\Configure\Exception\Exception
     */
